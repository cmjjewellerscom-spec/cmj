...
import { getAllProducts, updateProduct, getAllCollections, Product } from '@/data/productStore';
...
export default function EditProduct() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const finalImage = imageMode === 'upload' && uploadedImage ? uploadedImage : formData.image;
        ...
        const success = updateProduct(parseInt(productId), {
            name: formData.name,
        ...
        if (success) {
            ...
            alert('Cannot update default products in this demo. Only custom added products can be edited.');
            setLoading(false);
        }
    };

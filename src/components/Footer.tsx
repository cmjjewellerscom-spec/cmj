...
const Footer = () => {
    ...
    const quickLinks = [
        ...
        { name: "Signature Custom Creations", href: "/order/custom" },
        { name: "Heritage Bridal Collections", href: "/heritage-bridal" },
        { name: "Divine Gold Icons", href: "/divine-icons" },
        { name: "Premium Bullion", href: "/bullion" },
                        ...
                        <ul className="space-y-6">
                            ...
                            <li className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+917702592121" className="text-[#D3C4A5] hover:text-[#D4AF37] transition-colors text-sm font-mono">
                                        +91 7702592121
                                    </a>
                                </div>
                            </li>
